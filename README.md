...
This is designed to be run in the browser in order to work on any computer and not have any special runtime dependencies. This makes it much easier to use compared to a Node.js/Python script or similar.

## Usage:

1. Open https://modal.cx/blog/ (or a local version of the same page) in a browser.
2. Copy and paste the script [`generate-feed.js`](./generate-feed.js) into the dev tools console to generate the feed.
